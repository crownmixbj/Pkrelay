...
/*
  ...
  ⚠ A deliberate reversal, and the earlier reasoning is worth keeping.
    ...
    20250101000028_sender_identity.sql and the original `postingGate` argued that a sender
...
/*
  Replaces "sender creates own" from 20250101000009_bans.sql, which replaced 01's.
