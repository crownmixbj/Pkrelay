...
/*
  ...
  ⚠ The record of who posted a parcel was made by a second call that was
    ...
    statements, `20250101000014_liveness.sql` not being run so the function does not exist,
 ...
 *   stays, because `20250101000014_liveness.sql` grants it and something may still call it.
 */
  ...
  */
  ...
  /*
    ⚠ 'unavailable' passes; 'failed' does not.
      ...
      20250101000014_liveness.sql made this call and it still holds. A provider outage is
...
/*
  ...
  ⚠ The new line reads the *result* of the trigger, which is why this works.
    ...
    hard way in `20250101000040_review_controls.sql`. So by the time this is evaluated,
